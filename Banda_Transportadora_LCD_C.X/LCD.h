...
//Esta libreria es para el uso de una pantalla LCD 2x16 en modo de 4 bits
...
void sendData(char data, char mode); // Envia un dato al LCD y se selecciona el modo, si es un dato para imprimir (mode = 1) o es un comando (mode = 0)
void onLcd(); //Envia el comando de encendido fijado por harware externo
void initLcd(); //Env?a el comando para fijar la configuraci?n en 4 bits
